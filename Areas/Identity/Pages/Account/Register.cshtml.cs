...
namespace MiniFacebookProject1.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //public IFormFile Photo { get; set; } ImageFileName
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //        user.PhotoContentType = Input.Photo.ContentType;
                //    }
                //}
                ...
                if (result.Succeeded)
                {
                    ...
                    //if you want to add an admin replace the word "User" by "Admin"
